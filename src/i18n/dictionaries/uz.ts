...
export const uz: Dictionary = {
  ...
  devAiLog: {
    ...
    promoLink: "Test promokodlari",
    aiFailLink: "Sunʼiy intellekt nosozligini sinash",
    languageNames: { uz: "oʻzbek", ru: "rus" },
  },
  devPromo: {
    title: "Test promokodlari",
    note: "Xizmat sahifasi. Bu yerda yaratilgan kodlar faqat test toʻlovi yoqilgan joyda ishlaydi, asosiy saytda esa hech qachon ishlamaydi. Haqiqiy promokodlar boshqaruv panelida paydo boʻladi (8-bosqich).",
    testModeOff: "Test toʻlovi hozir oʻchirilgan (PAYMENTS_TEST_MODE), shuning uchun test kodlari qabul qilinmaydi.",
    created: "Promokod saqlandi. Uni hisobotni tanlash sahifasida kiriting.",
    invalid: "Kod: 3–32 ta lotin harfi, raqam, «-» yoki «_». Chegirma: 1 dan 100 % gacha.",
    code: "Kod",
    percent: "Chegirma, %",
    create: "Promokodni saqlash",
    listTitle: "Bazadagi promokodlar",
    empty: "Hozircha promokodlar yoʻq.",
    used: "ishlatilgan: {n}",
    active: "amal qiladi",
    inactive: "oʻchirilgan",
    real: "haqiqiy (boshqaruv panelida oʻzgartiriladi)",
    disable: "Oʻchirish",
    enable: "Yoqish",
  },
  devAiFail: {
